 ...
 * @author SystemX
 */
public class GetInvoiceUser extends AbstractGenericOperation {

    List<InvoiceUser> as = new ArrayList<>();
    ...
    protected void executeOperation(Object param) throws Exception {
        ResultSet rs = repository.get((InvoiceUser) param);
        while (rs.next()) {
